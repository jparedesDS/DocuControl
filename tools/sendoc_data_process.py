...
def sendoc_vendor_number(df):
    ...
    mapping = {'P1Q27002-PF-V': 'P-25/009-S00',}
...
def reconocer_tipo_proyecto(df):
    ...
    """
    mapping = {'P1Q27002-PF-V': 'TEMPERATURA',}

    # Asignamos el tipo de proyecto según el número de pedido
    df['Material'] = df['ProcessFlow'].map(mapping).fillna(df['ProcessFlow'])  # Si no se encuentra en el mapeo, deja el código original
