...
def apply_excel_styles(archivo_excel):
    ...
    # === Colores de pestañas ===
    hoja_colores = {'ALL DOC.': "6678AF", 'ENVIADOS': "00D25F", 'DEVOLUCIONES': "FFA19A", 'CRÍTICOS': "DBB054", 'CRÍTICOS +15d': "FF7F50", 'SIN ENVIAR' : "FFFF66", 'STATUS GLOBAL': "B1E1B9"}
    ...
    estado_colores = {"Rechazado": "FFA19A", "Com. Menores": "FFE5AD", "Com. Mayores": "DBB054", "Comentado": "F79646", "Enviado": "B1E1B9", "Sin Enviar": "FFFFAB", "Información": "FFFF46",
                      "HOLD": "FF0909", "Aprobado": "00D25F"}
