...
nombre_carpeta = os.path.join(f'\\10.1.20.6\\datos\\Comunes\\JOSE\\02 DEVOLUCIÓN DOCUMENTACIÓN\\PRODOC\\' +dia)
...
combine_path = f'\\10.1.20.6\\datos\\Comunes\\JOSE\\02 DEVOLUCIÓN DOCUMENTACIÓN\\PRODOC\\all_tr_combine.xlsx'
...
dst = f'\\10.1.20.6\\datos\\Comunes\\JOSE\\02 DEVOLUCIÓN DOCUMENTACIÓN\\PRODOC\\' +str(dia)    # Generamos una url de una nueva carpeta en la que iran los .xlsx
