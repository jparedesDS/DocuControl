...
path_total = 'C:\\Users\\alejandro.berzal\\Desktop\\DATA SCIENCE\\DocuControl\\data_import\\data_erp.xlsx'
...
df_comentado = erp_data[erp_data['Estado'] == 'Comentado']
df_rechazado = erp_data[erp_data['Estado'] == 'Rechazado']
df_comentados = pd.concat([df_menores, df_mayores, df_rechazado, df_comentado]) # Unimos los tres DataFrames
# Transformamos todas las columnas de fechas to_datetime
...
with pd.ExcelWriter(r'C:\\Users\\alejandro.berzal\\Desktop\\DATA SCIENCE\\DocuControl\\data\\monitoring_report_' + str(today_date_str) + '.xlsx', engine='xlsxwriter') as writer:
...
wb = Workbook('C:\\Users\\alejandro.berzal\\Desktop\\DATA SCIENCE\\DocuControl\\data\\monitoring_report_' + today_date_str + '.xlsx')
